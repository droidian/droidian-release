...
snapshot-control: out/droidian-current out/droidian-current.01_updates out/droidian-current.80_fxtec out/droidian-update out/support/buildd_support.list
