...
snapshot-control: out/droidian-current out/droidian-current.01_updates out/droidian-current.02_legacy out/droidian-current.80_fxtec out/droidian-current.80_volla_mimir out/droidian-update out/support/buildd_support.list
